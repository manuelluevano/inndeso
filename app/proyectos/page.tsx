...
const items = [
  ...
  },
  {
    ...
    result: 'Captación de clientes con catálogo editorial y formularios conectados a HubSpot',
    summary: 'Sitio de moda con carrusel de colecciones, grid de productos y CTA directo a Shopify.',
    message: 'Hola INNDESO, quiero un e-commerce como el de la boutique de moda.',
  },
  {
    title: 'E-commerce de cuidado personal',
    tags: ['Next.js', 'Marketing', 'Shopify'],
    img: '/portfolio/eccomerce2/beauty-1.jpg',
    result: 'Incremento en reservas de demo con métricas sociales y CTA directo a la tienda',
    summary: 'Landing de productos de belleza con storytelling, comparativos y preguntas frecuentes.',
    message: 'Hola INNDESO, necesito un e-commerce como el de cuidado personal.',
  },
  {
